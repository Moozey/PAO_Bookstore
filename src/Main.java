...
//        ca sa pot lucra cu orice functie din java, trebuie sa o apelez ori folosind numeleClasei.numeleFunctie ori numeObiect.numeFunctie
        ...
        System.out.println("TESTEZ findClientsWithOpenShoppingCart");
        for(int i = 0; i< clientInterface.findClientsWithOpenShoppingCart().size(); i++)
            System.out.println(clientInterface.findClientsWithOpenShoppingCart().get(i));
